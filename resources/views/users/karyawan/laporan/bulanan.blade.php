...
<div class="content py-10">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    @if($selected_ruangan)
                    <div>
                        <a href="{{ route('karyawan.laporan.bulanan') }}" class="btn btn-outline-primary"><i class="ti ti-arrow-left me-2"></i> Pilih Mesin Lain</a>
                    </div>
                    @endif
                </div>
            </div>
        ...
        <div class="row g-4 mt-2">
            ...
            <div class="col-md-6">
                <a href="{{ route('karyawan.laporan.bulanan', ['ruangan_id' => $ruang->id]) }}" class="text-decoration-none text-dark">
