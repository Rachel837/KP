                            ...
                            <form action="{{ route('karyawan.laporan.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama_jenazah') is-invalid @enderror" id="nama_jenazah" name="nama_jenazah" value="{{ old('nama_jenazah', $selectedJadwal ? ($selectedJadwal->pelanggan->nama ?? $selectedJadwal->nama_pelanggan) : '') }}" required placeholder="Nama Jenazah">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('usia_jenazah') is-invalid @enderror" id="usia_jenazah" name="usia_jenazah" value="{{ old('usia_jenazah', $selectedJadwal ? ($selectedJadwal->pelanggan->usia ?? $selectedJadwal->umur) : '') }}" required placeholder="Contoh: 60">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('tempat_lahir_jenazah') is-invalid @enderror" id="tempat_lahir_jenazah" name="tempat_lahir_jenazah" value="{{ old('tempat_lahir_jenazah', ($selectedJadwal && $selectedJadwal->pelanggan) ? $selectedJadwal->pelanggan->tempat_lahir : '') }}" required placeholder="Tempat Lahir Jenazah">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_lahir_jenazah') is-invalid @enderror" id="tanggal_lahir_jenazah" name="tanggal_lahir_jenazah" value="{{ old('tanggal_lahir_jenazah', ($selectedJadwal && $selectedJadwal->pelanggan) ? $selectedJadwal->pelanggan->tanggal_lahir : '') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama_penanggung_jawab') is-invalid @enderror" id="nama_penanggung_jawab" name="nama_penanggung_jawab" value="{{ old('nama_penanggung_jawab', ($selectedJadwal && $selectedJadwal->pelanggan) ? ($selectedJadwal->pelanggan->penannggung_jawab ?? $selectedJadwal->pelanggan->penanggung_jawab ?? '') : '') }}" required placeholder="Nama Penanggung Jawab">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('no_telepon_penanggung_jawab') is-invalid @enderror" id="no_telepon_penanggung_jawab" name="no_telepon_penanggung_jawab" value="{{ old('no_telepon_penanggung_jawab', ($selectedJadwal && $selectedJadwal->pelanggan) ? $selectedJadwal->pelanggan->no_telepon : '') }}" required placeholder="Contoh: 08123456789">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select @error('ruangan_id') is-invalid @enderror" id="ruangan_id" name="ruangan_id" required>
                                            <option value="" disabled {{ !$selectedJadwal ? 'selected' : '' }}>Pilih</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="time" class="form-control @error('waktu_tiba') is-invalid @enderror" id="waktu_tiba" name="waktu_tiba" value="{{ old('waktu_tiba', $selectedJadwal ? ($selectedJadwal->waktu_tiba ? substr($selectedJadwal->waktu_tiba, 0, 5) : '') : '') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="time" class="form-control @error('jam_awal') is-invalid @enderror" id="jam_awal" name="jam_awal" value="{{ old('jam_awal', $selectedJadwal ? ($selectedJadwal->jam_awal ? substr($selectedJadwal->jam_awal, 0, 5) : '') : '') }}" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="time" class="form-control @error('jam_akhir') is-invalid @enderror" id="jam_akhir" name="jam_akhir" value="{{ old('jam_akhir', $selectedJadwal ? ($selectedJadwal->jam_akhir ? substr($selectedJadwal->jam_akhir, 0, 5) : '') : '') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('jumlah_solar') is-invalid @enderror" id="jumlah_solar" name="jumlah_solar" value="{{ old('jumlah_solar', $selectedJadwal ? $selectedJadwal->jumlah_solar : '') }}" required placeholder="Contoh: 50.5">
