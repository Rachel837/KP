    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-lg-8 mx-auto">
                <div class="mb-4">
                    <h1 class="fs-3 mb-1">Tambah Pengguna Baru</h1>
                    <p>Silakan isi informasi di bawah ini untuk menambahkan pengguna.</p>
                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('role_idrole') is-invalid @enderror" id="role_idrole" name="role_idrole" required>
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->idrole }}" {{ old('role_idrole') == $role->idrole ? 'selected' : '' }}>{{ ucwords(str_replace('_', ' ', $role->nama)) }}</option>
                                    @endforeach
                                </select>
