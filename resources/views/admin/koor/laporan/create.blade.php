        ...
        <div class="row">
            <div class="col-12 col-lg-10 mx-auto">
                <div class="mb-4">
                    ...
                    <p>Silakan isi informasi di bawah ini untuk menambahkan laporan jadwal kremasi baru.</p>
                </div>
                        ...
                        <form action="{{ route('laporan.store') }}" method="POST">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('pelanggan_kremasi_id') is-invalid @enderror" id="pelanggan_kremasi_id" name="pelanggan_kremasi_id" required>
                                        ...
                                        @foreach($pelanggans as $pel)
                                            <option value="{{ $pel->id }}" {{ old('pelanggan_kremasi_id') == $pel->id ? 'selected' : '' }}>{{ $pel->nama }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" class="form-control @error('jam_meninggal') is-invalid @enderror" id="jam_meninggal" name="jam_meninggal" value="{{ old('jam_meninggal') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_meninggal') is-invalid @enderror" id="tanggal_meninggal" name="tanggal_meninggal" value="{{ old('tanggal_meninggal') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('pemakaian_listrik') is-invalid @enderror" id="pemakaian_listrik" name="pemakaian_listrik" value="{{ old('pemakaian_listrik') }}">
